...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li>Data Entry</li>
                <li class="active"><strong><mark>FSIC Application (Update Record) </mark></strong></li>
            </ul>
            ...
            $month= date("m", strtotime($fetch['month']));
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <form method="post" action="actions/editfsic.php">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                    <label for="brgy-no" class="col-sm-10 control-label">&nbsp;Type of Permit</label>
                                                    <div class="col-sm-7">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label for="user-id" class="col-sm-10 control-label">&nbsp; Phone
                                                    Number
                                                </label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" id="cpnumb" name="cpnumb"
                                                        value="<?php echo $fetch['cpnumb']?>" required readonly style="color: black;">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="status" class="col-sm-12 control-label"><br>Initial
                                                    Requirements</label>
                                                <div class="col-sm-12">
                                                    <?php
                                    ...
                                    ?>
                                                    <label><input type="checkbox" class="icheckbox" value="IniReq5"
                                                            name="initial_requirements[]" <?php if (in_array("IniReq5",
                                                            $check)){ echo "checked" ; } ?>
                                                        >Endorsement from Building Official (BO) / Business Permit
                                                        Licensing Office (BPLO)</label> <br>


                                                    <label><input type="checkbox" class="icheckbox" value="IniReq6"
                                                            name="initial_requirements[]" <?php if (in_array("IniReq6",
                                                            $check)){ echo "checked" ; } ?>
                                                        >&nbsp;"Photocopy of Building Permit and Assessment of
                                                        Occupancy Permit Fee / Asssessment of Business Permit Fee /
                                                        BPLO Assessment / Tax Bill for Business Permit as the case
                                                        maybe</label> <br>
                                                    <label><input type="checkbox" class="icheckbox" value="IniReq7"
                                                            name="initial_requirements[]" <?php if (in_array("IniReq7",
                                                            $check)){ echo "checked" ; } ?>
                                                        >&nbsp;Copy of Fire Insurance Policy (If Any)</label> <br>
                                                    <label><input type="checkbox" class="icheckbox" value="IniReq8"
                                                            name="initial_requirements[]" <?php if (in_array("IniReq8",
                                                            $check)){ echo "checked" ; } ?>
                                                        >&nbsp;Copy of Latest Fire Safety Inspection Certificate
                                                        Immediately Preceding this Application (If Any)</label>

                                                    <?php
                                        $initial_requirements = $fetch['initial_requirements'];
                                        $check = explode(",", $initial_requirements);
                                    ?>
                                                    <label><input type="checkbox" class="icheckbox" value="IniReq9"
                                                            name="initial_requirements[]" <?php if (in_array("IniReq9",
                                                            $check)){ echo "checked" ; } ?>
                                                        >Three (3) sets of Fire and Life Safety Assessment Report-2
                                                        (FALAR-2) for Occupancy Permit or FALAR 3 for Business Permit
                                                        (For Occupancy of at least 50 Persons)</label> <br>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        ...
                                                        <label for="confirm" style="display: none; font-size: 24px;text-align: center;"
                                                            id="confirmationfsicup" class="col-sm-12 control-label">
                                                            Are you sure you want to edit this FSIC Application?
                                                        </label>
                                                        <div class="col-sm-4">
                                                            &nbsp;
                                                        </div>
                                                        <div id="confirmedyes2">
                                                            <div class="col-sm-2">
                                                                <button type="submit" style="display:none;" class="btn btn-info"
                                                                    id="fsicyesup" name="editfsic"><span class="fa fa-check"></span>Yes</button>
                                                            </div>
                                                        </div>
                                                        <div id="confirmedno2">
                                                            <div class="col-sm-2">
                                                                <button type="button" style="display:none;" class="btn btn-danger"
                                                                    id="fsicnoup"><span class="fa fa-times"></span>No</button>
                                                            </div>
                                                        </div>
                                                        <!-- </ul>-->
                                                    </div>
                        ...
                        <div class="panel-footer">
                            ...
                            <a class="btn btn-info" onclick="myFunctionFSICUp()"><span class="fa fa-check"></span>Confirm</a>
    ...
    <script>
        function myFunctionFSICUp() {
            document.getElementById("confirmationfsicup").style.display = "block";
            document.getElementById("fsicyesup").style.display = "inline";
            document.getElementById("fsicnoup").style.display = "inline";
        }
    </script>
    <!-- <script>
        function close() {
