...
<html lang="en">
    <head>        
        ...
        <?php require 'loadchart/transactions.php'?>
        <style>
            @media print{

                @page {
                    margin: -155px 10px 10px -200px;
                    size: letter;
                }
                .listheading{
                                    ...
                                    <div class="btn-group pull-left">
                                        <div class="form-group">
                                            <select class="form-control select input-sm" data-style="btn-info" id="select-report" name="filterbutton">
                                                ...
                                                <option value="overall">Overall Transaction Status</option>
                                                <option value="building">Building Evaluation</option>
                                                <option value="certification">Certification</option>
                                                <option value="payment">Monthly Payment</option>
                                                <option value="yearlypayment">Yearly Payment</option>
                                                <option value="pendingschedule">Pending Schedule</option>
                                            </select>
    ...
    date_default_timezone_set('Asia/Manila');
        $today = date("M-d-Y");
                                        ...
                                        <div id="chartContainer2" class="overall reporttype" style="width: 100%; height: 300px"></div>
                                        <div id="chartContainer3" class="building reporttype" style="width: 100%; height: 300px"></div>
                                        <div id="chartContainer4" class="certification reporttype" style="width: 100%; height: 300px"></div> 
                                        <div id="chartContainer5" class="payment reporttype" style="width: 100%; height: 300px"></div> 
                                        <div id="chartContainer6" class="yearlypayment reporttype" style="width: 100%; height: 300px"></div> 
                                        <?php require 'filterreports/overalltransactions.php'?>
                                        <?php require 'filterreports/evaluation.php'?>
                                        <?php require 'filterreports/certification.php'?>
                                        <?php require 'filterreports/payment.php'?>
                                        <?php require 'filterreports/yearlypayment.php'?>
                                        <?php require 'filterreports/schedulereminder.php'?>
                                        <hr>
        ...
        <script>
            ...
            $(document).ready(function(){
                $("#pyear").on('change', function(){
                    var year=$(this).val();
                    window.location = 'Report-Transaction.php?year='+year;
                });
            });
        </script>
    </body>
