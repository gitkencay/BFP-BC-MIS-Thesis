    ...
    <ul class="x-navigation">
        ...
        <div class="profile">
            ...
            <div class="profile-data">
                ...
                <div class="profile-data-title">Inspector</div>
            </div>
        </div>
        <ul id="navSid">                                                                            
            <li>
                <a href="home-Inspector.php"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
            </li>                    
            <li class="xn-openable">
                <a href="#"><span class="fa fa-file-text-o"></span> <span class="xn-text">Transaction</span></a>
                    <ul>
                        <li><a href="Transaction-Scheduling-Inspector.php">Scheduling</a></li>    
                    </ul>
            </li>                                                        
        </ul>
        <!-- END X-NAVIGATION -->
