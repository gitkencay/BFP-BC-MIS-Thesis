...
<div class="page-sidebar">
    ...
    <ul class="x-navigation">
        <li class="xn-logo">
            <a href="home-Assessor.php"><strong>BFP-BC MIS</strong></a>
        ...
        <div class="profile">
            ...
            <div class="profile-data">
                ...
                <div class="profile-data-title">Fire Code Assessor </div>
            </div>
        </div>
        <ul id="navSid">                                                                            
            <li>
                <a href="home-Assessor.php"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
            </li>                    
