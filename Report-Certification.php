...
$query3 = $conn->query("select * from `application` where assessment_status = 'Evaluated' && application_type = 'FSEC' && year = '$year'") or die(mysqli_error());
while ($fetch3 = $query3->fetch_array()) {
    ...
    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $fetch3['cert_status'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $fetch3['released_date'];?>
                                                            </td>
                                                            <td>
                                                                <a href="Reports/FSEC-Certificate.php?id=<?php echo $fetch3['application_no'] ?>&owner_name=<?php echo $fetch3['owner_name'] ?>"
                                                                    class="btn btn-default btn-sm" data-toggle="tooltip"
                                                                    data-placement="left" title="Print Preview"> <i
                                                                        class="fa fa-eye"></i> Preview</a>
                                                                        <a href="#edit_status<?php echo $fetch3['application_no']; ?>" data-target="#edit_status<?php echo $fetch3['application_no']; ?>" data-toggle="modal"> <i class="fa fa-edit">Update</i></button>
                                                            </td>
                                                        </tr>
                                                        <?php
}
...
$query2 = $conn->query("SELECT * from `application` where assessment_status = 'Inspected' && application_type = 'FSIC' && year='$year'") or die(mysqli_error());
while ($fetch2 = $query2->fetch_array()) {
    ...
    ?>
                                                        <tr>
                                                            <td>
                                                                <?php echo $fetch2['year'] . '-' . $month . '-' . $fetch2['application_no'] ?>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <?php echo $fetch2['type_of_permit'] ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $date ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $fetch2['cert_status'];?>
                                                            </td>
                                                            <td>
                                                                <?php echo $fetch2['released_date'];?>
                                                            </td>
                                                            <td>
                                                                <?php echo $fetch2['expiration_date'];?>
                                                            </td>
                                                            <td>
                                                                <?php
if ($fetch2['type_of_permit'] == 'Business') {
        $permit = 'BP';
    }
    ...
    ?>
                                                                <a href="Reports/FSIC-Certificate-<?php echo $permit ?>.php?id=<?php echo $fetch2['application_no'] ?>&owner_name=<?php echo $fetch2['owner_name']?>"
                                                                    class="btn btn-default btn-sm" data-toggle="tooltip"
                                                                    data-placement="left" title="Print Preview"> <i
                                                                        class="fa fa-eye"></i> Preview</a>
                                                                        <a href="#edit_status<?php echo $fetch2['application_no']; ?>" data-target="#edit_status<?php echo $fetch2['application_no']; ?>" data-toggle="modal"> <i class="fa fa-edit">Update</i></button>
                                                            </td>
                                                        </tr>
                                                        <?php
}
...
?>
            ...
            <?php require 'modals/CertificateStatus.php'?>
            <script>
        ...
        <script>
            $(document).ready(function () {
                $("#pyear").on('change', function () {
                    var year = $(this).val();
                    window.location = 'Report-Certification.php?year=' + year;
                });
            });
        </script>
