...
if(isset($_POST['submit'])){
    ...
    $conn->query("INSERT INTO `application` VALUES('', 'FSIC', '$application_name', '$business_name', '$establishment_address', '$building_type', '$barangay_name', '$type_of_permit', '$cpnumb', '$croname', '$date', '$owner_name', '$number_of_floors', '$lot_size', '$status', '$new', 'Unassessed', '$month', '$year', '$date_applied')") or die(mysqli_error());
