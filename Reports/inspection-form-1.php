...
?>
								...
								<table id="one" border="1" cellspacing="0">
									<tr>
										<th width="30%">TO</th>
										<th>1</th>
										<th><strong> <p> <?php echo $fetch['owner_name']?> </p> </strong></th>
									</tr>
									<tr>
										<th width="30%">PROCEED</th>
										<th>2</th>
										<th><strong> <p> <?php echo  $fetch['recommendation']?> </p> </strong></th>
									</tr>
									<tr>
									...
									<tr>
										<th width="30%">REMARKS OR <br>ADDITIONAL INSTRUCTIONS</th>
										<th>1</th>
										<th><strong> <p> <?php echo $fetch['owner_name']?> </p> </strong></th>
									</tr>
