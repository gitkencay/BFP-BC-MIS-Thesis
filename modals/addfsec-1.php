...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="croname" name="croname" value="<?php echo $officername?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="owner-name2" name="owner_name">
                                </div>
                            </div>
                            <br>
                            <div class="form-group">
