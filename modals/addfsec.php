<div class="modal fade" id="FSEC-Reg" role="dialog" aria-labelledby="largeModalHead" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="fsec" method="post" action="actions/addfsec.php">
...
?>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" readonly class="form-control text-primary" id="app-no" name="application_no"
                            ...
                            <div class="form-group">
                                <label for="busi-name" class="col-sm-5 control-label">Establishment Address</label>
                                <div class="col-sm-10">
                                    <input data-toggle="tooltip" data-placement="left" title="*Required, Establishment Address" type="text" class="form-control" id="busi-nme" name="bussaddress">
                                </div>
                            </div>
                            <div class="form-group">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input data-toggle="tooltip" data-placement="left" title="*Required, Establishment Address" type="hidden" class="form-control" id="estab-add" name="establishment_address" value="NA">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input style="color: black" type="text" class="form-control" id="croname" name="croname" value="<?php echo $officername?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{,}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label><input type="checkbox" class="icheckbox" value="IniReq1" name="initial_requirements[]">&nbsp;Endorsement
                                        from Building Official (BO)</label> <br>

                                    <label><input type="checkbox" class="icheckbox" value="IniReq2" name="initial_requirements[]">&nbsp;Three
                                        (3) Sets of Building Plans and Specifications</label> <br>

                                    <label><input type="checkbox" class="icheckbox" value="IniReq3" name="initial_requirements[]">&nbsp;One
                                        (1) Set of Bills of Materials and Cost Estimate</label> <br>

                                    <label><input type="checkbox" class="icheckbox" value="IniReq4" name="initial_requirements[]">&nbsp;
                                        Three (3) Sets of Detailes Fire Safety Plans and Specifications or &emsp;&emsp;
                                        (FALAR-1) for Occupancy of at least 50 persons</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <!-- <ul class="panel-controls"> -->
                                            <label for="confirm" style="display: none; font-size: 24px;text-align: center;" id="confirmationfsec"  class="col-sm-12 control-label">
                                            Are you sure you want to add this FSEC Application?
                                            </label>
                                            <div class="col-sm-2">
                                                    &nbsp;
                                            </div>
                                            <div id="confirmedyes2">
                                                <div class="col-sm-5">
                                                    <button type="submit" style="display:none;" class="btn btn-info" id="fsecyes" name="submit"><span class="fa fa-check"></span>Yes</button>
                                                </div>
                                            </div>
                                            <div id="confirmedno2">
                                                <div class="col-sm-5">
                                                    <button type="button" style="display:none;" class="btn btn-danger" id="fsecno" data-dismiss="modal"><span class="fa fa-times"></span>No</button>
                                                </div>
                                            </div>    
                                        <!-- </ul>-->
                                    </div>    
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" onclick="myFunctionFSEC()"><span class="fa fa-check"></span>Confirm</button>
                </div>
            </form>
