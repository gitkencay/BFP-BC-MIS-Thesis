        ...
        <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <h3 class="modal-title">FSEC Assessment Pending List</h3>
                        </div>
...
$query = $conn->query("select * from `application` where assessment_status = 'Unassessed' && status = 'Complete' && application_type = 'FSEC' && year = '$year'") or die(mysqli_error());
