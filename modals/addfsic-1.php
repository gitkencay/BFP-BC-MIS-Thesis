<div class="modal fade" id="FSIC-Reg" role="dialog" aria-labelledby="largeModalHead" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" action="actions/addfsic.php" onsubmit="return confirm('Are you sure you want to add this FSIC application?');">
...
-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="croname" name="croname" value="<?php echo $officername?>">
                                </div>
                            </div>
                            <div class="form-group">
