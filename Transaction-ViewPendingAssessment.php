...
?>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <label for="location" class="col-md-8 control-label">Location&nbsp;&nbsp;</label>
                                                <div class="col-sm-10">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-sm-7">
                                                    ...
                                                    <input data-toggle="tooltip" data-placement="right" title="*Required, Applicant Full Payment" type="text" class="form-control" id="paymentview" name="paymentview">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-info" onclick="compChange()" id="changebtn">Change</button></td>
                                            <td>
                                                <div class="col-sm-7">
                                ...
                                <script type="text/javascript">
                                    ...
                                    <div class="panel-footer">
                                        ...
                                        <input type="hidden" class="form-control" id="message" name="message"  value="<?php echo "BFP-Bacolod City : " .($datesms). " Mr/Ms " . $fetch['owner_name'] . " your ASSESSMENT  with the transaction ID of ". $textid ." was successfully verified. \n\nDo not reply on this number. \n\nIn case of Emergency please contact 117 or 434-5022 or 434-5023." ?>">
                                        <input type="hidden" class="form-control" id="message2" name="message2" value="<?php echo "BFP-Bacolod City : " .($datesms). " Mr/Ms " . $fetch['owner_name'] . " your ASSESSMENT with the transaction ID of ". $textid ." was put on hold because you have not fully paid the required amount for your application. \n\nDo not reply on this number. \n\nIn case of Emergency please contact 117 or 434-5022 or 434-5023." ?>">
