...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `application` where building_type = '$_GET[building]' && year = '$_GET[year]'") or die(mysqli_error());
            $fetch = $query->fetch_array();
            $month = $fetch['month'];
            $year = $fetch['year'];
            $building_type = $fetch['building_type'];
                        ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        <h3> &nbsp; List of Applicants with Building Type: <?php echo $fetch['building_type'];?> |  Year <?php echo $year?> </h3>
                    ...
                    <div class="panel-body">
                        <div id="print">
                            <div class="listheading" style="display: none">
                                ...
                                <br>
                                <br>
                                <h3> List of Applicant with Building Type: <?php echo $fetch['building_type'];?>  Year <?php echo $year?> </h3>
                                <br>
                                <br>
                            </div>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `application` where building_type = '$building_type' && year = '$year'") or die(mysqli_error());
