...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Inspection Completed List</mark></strong></li>
            </ul>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `inspection_order` where 'status' = 'for certification'  && year = '$_GET[year]'") or die(mysqli_error());
            ...
            $year = $fetch['year'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp; List of Inspection Status: For Certification |  Year <?php echo $year?> </h3>
...
$query2 = $conn->query("SELECT * FROM `inspection_order` where year = '$year' && status = 'for certification' ") or die(mysqli_error());
while ($fetchb = $query2->fetch_array()) {
    ?>
            <tr>
                <td>
                    <?php echo $fetchb['io_no'] ?>
                </td>
                <td>
                    <?php echo $fetchb['owner_name'] ?>
                </td>
                <td>
                    <?php echo $fetchb['owner_address'] ?>
                </td>
                <td>
                    <?php echo $fetchb['business_name'] ?>
                </td>
                <td>
                    <?php echo $fetchb['inspection_cro'] ?>
                </td>
                <td>
