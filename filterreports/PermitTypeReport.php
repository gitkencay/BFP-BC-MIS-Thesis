    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Type of Permit Report</mark></strong></li>
            </ul>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `application` where type_of_permit = '$_GET[permit]' && year = '$_GET[year]'") or die(mysqli_error());
            $fetch = $query->fetch_array();
            $month = $fetch['month'];
            $year = $fetch['year'];
            $type_of_permit = $fetch['type_of_permit'];
                        ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        <h3> &nbsp; List of Applicants with <?php echo $fetch['type_of_permit'];?> Permit |  Year <?php echo $year?> </h3>
                    ...
                    <div class="panel-body">
                        <div id="print">
                            <div class="listheading" style="display: none">
                                ...
                                <br>
                                <br>
                                <h3> List of Applicant with <?php echo $fetch['type_of_permit'];?> Permit Year <?php echo $year?> </h3>
                                <br>
                                <br>
                            </div>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `application` where type_of_permit = '$type_of_permit' && year = '$year'") or die(mysqli_error());
