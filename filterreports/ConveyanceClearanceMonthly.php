...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
                        ...
                        $year = $fetch['year'];
                        ?>
                        <h3> Conveyance Clearance Fee </h3>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `assessment` where month = '$month' && conveyance_clearance != '0' && year = '$year' order by conveyance_clearance DESC") or die(mysqli_error());
                                        while ($fetchb = $query2->fetch_array()) {
                                            $totaldue = number_format($fetchb['conveyance_clearance'],2,".",",");
                                        ?>
