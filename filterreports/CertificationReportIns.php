    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>FSIC Certificate Report</mark></strong></li>
            </ul>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
                        ...
                        ?>
                        <h3> &nbsp; List of Applicants with FSIC |  Year <?php echo $year?> </h3>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `application` where assessment_status = 'Inspected' && `year` = '$year'") or die(mysqli_error());
                                        while ($fetchb = $query2->fetch_array()) {
                                        ?>

                                    <tr>
                                        <td><?php echo $fetchb['owner_name']?></td>
                                        <td><?php echo $fetchb['business_name']?></td>
                                        <td><?php echo $fetchb['building_type']?></td>
                                        <td><?php echo $fetchb['type_of_permit']?></td>
                                        <td><?php echo $fetchb['barangay_name']?></td>
                                        <td><?php echo $fetchb['date_applied']?></td>
                                    </tr>
                                    <?php
                                        }
                                        ?>
