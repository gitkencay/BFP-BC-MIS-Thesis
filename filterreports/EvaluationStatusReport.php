    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Evaluation Checklist Status Report</mark></strong></li>
            </ul>
            <div class="page-content-wrap">
                <div class="row">
                    <?php
    require '../require/databaseconnection.php';
            $query = $conn->query("SELECT * FROM `evaluation_checklist` where status = '$_GET[status]'") or die(mysqli_error());
            ...
            $status = $fetch['status'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp; Evaluation Status: <?php echo $fetch['status'];?> |  Year <?php echo $year?> </h3>
                        ...
                        <div id="print">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    <?php
    require '../require/databaseconnection.php';
                                        $query2 = $conn->query("SELECT * from `evaluation_checklist` where status = '$status' && `year` = '$year'") or die(mysqli_error());
                                        while ($fetchb = $query2->fetch_array()) {
                                        ?>

                                    <tr>
                                    <td><?php echo $fetch['owner_name']?></td>
                <td><?php echo $fetchb['business_name']?></td>
                <td><?php echo $fetchb['plan_evaluator']?></td>
                <td><?php echo $fetchb['project_title']?></td>
                <td><?php echo $fetchb['status']?></td>
                                    </tr>
                                    <?php
                                        }
                                        ?>
