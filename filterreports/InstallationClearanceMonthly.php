...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
                        ...
                        $query = $conn->query("SELECT * FROM `assessment` where month = '$_GET[month]' && year = '$_GET[year]'") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                        $month = $fetch['month'];
                        $year = $fetch['year'];
                        ?>
                        <h3> Installation Clearance Fee </h3>
                        <h3> &nbsp; List of Applicants that paid on the month of <?php echo $month?> |  Year <?php echo $year?> </h3>
                    ...
                    <div class="panel-body">
                        <div id="print">
                            <div class="listheading" style="display: none">
                                ...
                                <br>
                                <h3> Installation Clearance Fee </h3>
                                <h3> List of Applicants that paid on the month of <?php echo $month;?> <?php echo $year?> </h3>
                                <br>
                                <br>
                            </div>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `assessment` where month = '$month' && installation_clearance != '0' && year = '$year' order by installation_clearance DESC") or die(mysqli_error());
                                        while ($fetchb = $query2->fetch_array()) {
                                            $totaldue = number_format($fetchb['installation_clearance'],2,".",",");
                                        ?>
