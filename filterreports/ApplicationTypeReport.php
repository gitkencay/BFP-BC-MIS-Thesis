    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Building Type Report</mark></strong></li>
            </ul>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `application` where application_type = '$_GET[type]' && year = '$_GET[year]'") or die(mysqli_error());
            $fetch = $query->fetch_array();
            $month = $fetch['month'];
            $year = $fetch['year'];
            $application_type = $fetch['application_type'];
                        ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        <h3> &nbsp; List of Applicants with Application Type: <?php echo $fetch['application_type'];?> |  Year <?php echo $year?> </h3>
                    ...
                    <div class="panel-body">
                        <div id="print">
                            <div class="listheading" style="display: none">
                                ...
                                <br>
                                <br>
                                <h3> List of Applicant with Application Type: <?php echo $fetch['application_type'];?>  Year <?php echo $year?> </h3>
                                <br>
                                <br>
                            </div>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `application` where application_type = '$application_type' && year = '$year'") or die(mysqli_error());
