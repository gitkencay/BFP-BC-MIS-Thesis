    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Monthly Applicant Report</mark></strong></li>
            </ul>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `application` where month = '$_GET[month]' && year = '$_GET[year]'") or die(mysqli_error());
            ...
            $year = $fetch['year'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp;<?php echo $month ?> Applicant Report |  Year <?php echo $year?> </h3>
    ...
    if(isset($_GET['year']))
{
    $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `application` where month = '$month' && year = '$year'") or die(mysqli_error());
