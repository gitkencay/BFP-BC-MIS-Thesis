...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `evaluation_checklist` where status = 'On Progress'  && year = '$_GET[year]'") or die(mysqli_error());
            ...
            $year = $fetch['year'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp; List of Evaluation Status: On Progress |  Year <?php echo $year?> </h3>
...
$query2 = $conn->query("SELECT * FROM `evaluation_checklist` where year = '$year' && status = 'On Progress' ") or die(mysqli_error());
