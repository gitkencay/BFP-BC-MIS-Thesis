    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Assessment Completed List</mark></strong></li>
            </ul>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `assessment` where status = 'Complete'  && year = '$_GET[year]'") or die(mysqli_error());
            ...
            $year = $fetch['year'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp; List of Assessment Status: Complete |  Year <?php echo $year?> </h3>
...
$query2 = $conn->query("SELECT * FROM `assessment` where year = '$year' && status = 'Complete' ") or die(mysqli_error());
while ($fetchb = $query2->fetch_array()) {
    ?>
            <tr>
                ...
                <td>
                    <?php echo $fetchb['total_amount'] ?>
                </td>
                <td>
                    <?php echo $fetchb['assessor_name'] ?>
                </td>
                <td>
