...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `application` where status = 'Pending'  && year = '$_GET[year]'") or die(mysqli_error());
            ...
            $year = $fetch['year'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp; List of Application Status: Pending |  Year <?php echo $year?> </h3>
...
$query2 = $conn->query("SELECT * FROM `application` where year = '$year' && status = 'Pending' ") or die(mysqli_error());
