...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Assessment Pending List</mark></strong></li>
            </ul>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `assessment` where status = 'Pending'  && year = '$_GET[year]'") or die(mysqli_error());
            ...
            $year = $fetch['year'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp; List of Assessment Status: Pending |  Year <?php echo $year?> </h3>
...
$query2 = $conn->query("SELECT * FROM `assessment` where year = '$year' && status = 'Pending' ") or die(mysqli_error());
