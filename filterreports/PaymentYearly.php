    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Yearly Payment Report</mark></strong></li>
            </ul>
            <div class="page-content-wrap">
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        $year = $fetch['year'];
                        ?>
                        <h3> &nbsp; List of Applicants that paid for the Year <?php echo $year?> </h3>
                        ...
                        <div id="print">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    <?php
    require '../require/databaseconnection.php';
                                        $query2 = $conn->query("SELECT * from `assessment` where year = '$year' order by total_amount DESC") or die(mysqli_error());
