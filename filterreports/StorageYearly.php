...
if(isset($_GET['year']))
{
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `assessment` where storage_clearance != '0' && year = '$year' order by storage_clearance DESC") or die(mysqli_error());
