...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>Application Completed List</mark></strong></li>
            </ul>
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
            ...
            $query = $conn->query("SELECT * FROM `application` where status = 'Complete'  && year = '$_GET[year]'") or die(mysqli_error());
            ...
            $year = $fetch['year'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3> &nbsp; List of Application Status: Complete |  Year <?php echo $year?> </h3>
...
$query2 = $conn->query("SELECT * FROM `application` where year = '$year' && status = 'Complete' ") or die(mysqli_error());
