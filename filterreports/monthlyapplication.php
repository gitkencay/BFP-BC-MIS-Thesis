    ...
    <table  class="table table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="buttonhide"><a href="filterreports/MonthlyApplicantReport.php?month=<?php echo $fetch['month']?>&year=<?php echo $year?>" class="btn btn-default btn-sm">  <i class="fa fa-eye"></i>  Preview</a></td>
            </tr>
            <?php
            }
            ?>
