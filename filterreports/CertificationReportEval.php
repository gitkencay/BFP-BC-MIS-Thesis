    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><strong><mark>FSEC Certificate Report</mark></strong></li>
            </ul>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
                        ...
                        ?>
                        <h3> &nbsp; List of Applicants with FSEC |  Year <?php echo $year?> </h3>
...
if(isset($_GET['year']))
{
    $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `application` where assessment_status = 'Evaluated' && year = '$year'") or die(mysqli_error());
