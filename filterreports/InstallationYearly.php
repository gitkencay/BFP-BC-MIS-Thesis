...
if(isset($_GET['year']))
{
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `assessment` where installation_clearance != '0' && year = '$year' order by installation_clearance DESC") or die(mysqli_error());
