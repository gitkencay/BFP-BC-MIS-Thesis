...
if(isset($_GET['year']))
{
    ...
    if(isset($_GET['year']))
    {
        $year=$_GET['year'];
                                        ...
                                        $query2 = $conn->query("SELECT * from `assessment` where conveyance_clearance != '0' && year = '$year' order by conveyance_clearance DESC") or die(mysqli_error());
